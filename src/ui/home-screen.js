  ...
  el.innerHTML = `
    ...
    <div class="home__content">
      ...
      <main class="home__actions">
        <button class="btn btn--primary" data-role="start" type="button">开始游戏</button>
        <div class="home__links">
          <button class="btn btn--ghost" data-role="guide" type="button">玩法向导</button>
          <button class="btn btn--ghost" data-role="settings" type="button">设置</button>
        </div>
      </main>
